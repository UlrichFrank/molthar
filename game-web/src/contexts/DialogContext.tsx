...
export type DialogState =
  | { type: 'none' }
  | { type: 'replacement'; newCharacter: CharacterCard; portalCharacters: CharacterCard[]; canDiscard: boolean }
...
export interface DialogContextType {
  dialog: DialogState;
  openReplacementDialog: (newCharacter: CharacterCard, portalCharacters: CharacterCard[], canDiscard?: boolean) => void;
...
export function DialogProvider({ children }: { children: React.ReactNode }) {
  ...
  const openReplacementDialog = useCallback((newCharacter: CharacterCard, portalCharacters: CharacterCard[], canDiscard = true) => {
    setDialog({ type: 'replacement', newCharacter, portalCharacters, canDiscard });
  }, []);
