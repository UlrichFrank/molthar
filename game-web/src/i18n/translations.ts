...
const de: Record<TranslationKey, string> = {
  ...
  'create.npcStrategy.greedy':   'Weiser Wendelin (Stratege)',
  'create.npcStrategy.diamond':  'Edelsteinsammlerin Erda (Sammler)',
  'create.npcStrategy.efficient': 'Weiser Wendelin (Stratege)',
...
const enGB: Record<TranslationKey, string> = {
  ...
  'create.npcStrategy.greedy':   'Weiser Wendelin (Strategist)',
  'create.npcStrategy.diamond':  'Edelsteinsammlerin Erda (Gatherer)',
  'create.npcStrategy.efficient': 'Weiser Wendelin (Strategist)',
...
const fr: Record<TranslationKey, string> = {
  ...
  'create.npcStrategy.greedy':   'Weiser Wendelin (Stratège)',
  'create.npcStrategy.diamond':  'Edelsteinsammlerin Erda (Collectionneuse)',
  'create.npcStrategy.efficient': 'Weiser Wendelin (Stratège)',
  'create.npcStrategy.aggressive': 'Raubritter Ralf (Raider)',
