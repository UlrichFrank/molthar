...
export class RoomManager {
  ...
  createRoom(hostId: string, hostName: string, maxPlayers: number = 2, includeAI: boolean = false): GameRoom {
  ...
  getRoomStats(): { totalRooms: number; waitingRooms: number; playingRooms: number; totalPlayers: number } {
