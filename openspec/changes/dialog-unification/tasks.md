...
- [ ] 1.1 `game-web/src/styles/dialogs.css` erstellen mit allen `game-dialog-*` Klassen:
...
- [ ] 1.2 `game-web/src/components/GameDialog.tsx` erstellen mit:
...
- [ ] 1.3 Import von `dialogs.css` in `CanvasGameBoard.tsx` hinzufügen

## 2. Dialoge umstellen

- [ ] 2.1 `CharacterActivationDialog.tsx` auf `GameDialog` + `CardPicker` + `GameDialogActions` umstellen; inline-Tailwind für Overlay/Modal entfernen
- [ ] 2.2 `CharacterReplacementDialog.tsx` auf `GameDialog` + `GameDialogActions` umstellen; inline-Tailwind für Overlay/Modal entfernen
- [ ] 2.3 `DiscardCardsDialog.tsx` auf `GameDialog` + `CardPicker` + `GameDialogActions` umstellen; inline-Tailwind für Overlay/Modal entfernen
- [ ] 2.4 `ActivatedCharacterDetailView.tsx` auf `GameDialog variant="split"` umstellen; inline-Tailwind für Overlay/Modal entfernen

## 3. Verifikation

- [ ] 3.1 TypeScript-Kompilierung prüfen: `cd game-web && pnpm run type-check` fehlerfrei
