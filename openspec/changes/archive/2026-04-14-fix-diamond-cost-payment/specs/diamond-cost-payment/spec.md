...
Wenn der Spieler eine Aktivierung mit Diamantkosten bestätigt, MUSS die `PaymentSelection`-Liste eine Eintrag mit `source: 'diamond'` und dem korrekten `value` enthalten.
...
- **THEN** wird `player.diamonds` um genau 1 verringert
